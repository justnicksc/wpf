...
(totalWater >= totalWaterNeeded) ? console.log ("You have enough water for the whole group") : console.log ("You might want to lose dave. There is not enough water");// this let them know if they have enough water